    ...
    <div class="flex items-start justify-center min-h-[calc(100vh-120px)] px-6 pt-36">
        <div class="w-full max-w-4xl">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <form action="{{ route('tutor.materials.primary.unified.upload') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    @csrf

                    <div class="space-y-2">
                        <input type="hidden" name="subject_id" value="{{ $primarySubject->id }}">
                        <p>Subject: {{ $primarySubject->name }}</p>
